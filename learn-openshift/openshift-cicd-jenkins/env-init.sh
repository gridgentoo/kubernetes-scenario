...
ssh root@host01 "oc create -f https://github.com/openshift/origin/raw/release-3.11/examples/jenkins/application-template.json -n openshift"
ssh root@host01 "oc create -f https://github.com/openshift/origin/raw/release-3.11/examples/jenkins/jenkins-ephemeral-template.json -n openshift"
ssh root@host01 "oc create -f https://github.com/openshift/origin/raw/release-3.11/examples/jenkins/pipeline/samplepipeline.yaml -n openshift"
